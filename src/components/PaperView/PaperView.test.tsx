...
beforeEach(() => {
    render(
        <Router>
            <Provider store={store}><PaperView employeesActions={store.dispatch} first_name="Andrew" last_name="Simons" email="andrews@gmail.com" number="+94760001111" gender="M" photo="https://randomuser.me/api/portraits/men/30.jpg" id="636deb60d0fafa1da15e1221"/></Provider>
        </Router>
    )
})
